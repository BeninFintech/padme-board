let chart1 = Highcharts.chart('highchart', {
    chart: {
        type: 'spline'
    },
    title: {
...
let chart2 = Highcharts.chart('highchart2', {
    chart: {
        type: 'column',
        options3d: {
            enabled: true,
...
let chart3 = Highcharts.chart('basic-last-now', {

    title: {
        text: 'Volume des collectes en fonction des agences'
    },
    ...
    xAxis: {
        categories: ['TIKOPE', 'IE-VILLE', 'TOVE', 'TE', 'OLI', 'HERE', 'OLO', 'NAOLO', 'GNOHOU', 'OU', 'AMBA', 'VILLE']
    },
    ...
    series: [{
        ...
        name: 'Mois passé',
        data: [24916, 24064, 29742, 29851, 32490, 30282, 38121, 40434, 40434, 40434, 40434, 40434]
    }],
...
let chart4 = Highcharts.chart('variation-last-now', {
    chart: {
        type: 'column'
    },
    title: {
